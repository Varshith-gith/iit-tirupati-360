"""
Convert Buildings Folder Shapefiles to GeoJSON
Requires: pip install geopandas
Run: python convert_buildings.py
"""
...
input_dir = Path(r"F:\buildings")
output_dir = Path(r"F:\iit tirupati 360")
...
def main():
    print("=" * 60)
    print("Buildings Folder Shapefile to GeoJSON Converter")
    print("=" * 60)
    ...
    if success_count == total_count:
        ...
        print("GeoJSON files are now in the project directory.")
    else:
